...
<div class="mainmenu-wrapper">
    <div class="container">
        ...
        <nav id="mainmenu" class="mainmenu">
            <ul>
                <li class="logo-wrapper"><a href="admin_login.php" style="border:none ! important;"><img
                ...
                <div class="basic-login" style="margin: auto auto auto;width: 50%;">
                    <form role="form" onSubmit="return validate()" action="admin_login.php" method="post">
                        <div class="form-group">
                            ...
                            <input name="login-email" onKeyUp="hide_nxt(this)" onKeyDown="hide_nxt(this)"
                                   class="form-control"
                                   value="" id="login-username" type="text" placeholder="Mobile No"
                                   onkeypress="javascript:return isNumberKey(event);" onchange="UnameCheck(this);"
                                   autocomplete="off" onc><span class="error" id="dd"><p></p></span>
                        </div>

                        <div class="form-group">
                            <label for="login-password"><i class="icon-lock"></i> <b>Password * </b></label>
                            <input name="password" onKeyUp="hide_nxt(this)" onKeyDown="hide_nxt(this)"
                                   class="form-control" value="" id="login-password" type="password" placeholder=""
                                   autocomplete="off">
