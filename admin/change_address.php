                    ...
                    <div class="box">
                        ...
                        <div class="box-body ">
                            <form class="form-horizontal" action="change_address.php" method="post">
                                ...
                                <div class="form-group">
                                    <label for="price" class="col-xs-2 col-lg-2 col-sm-4">Address line 1:</label>
                                    <div class="col-xs-10 col-lg-10 col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="text" class="col-xs-2 col-lg-2 col-sm-4">Address line 2
                                        (optional):</label>
                                    <div class="col-xs-10 col-lg-10 col-sm-8">
                                        <input type="text" class="form-control" name="address_line2"
                                               value="<?php echo isset($data['address_line2']) ? html_entity_decode(stripcslashes($data['address_line2'])) : "" ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="text" class="col-xs-2 col-lg-2 col-sm-4">State/province
                                        (optional):</label>
                                    <div class="col-xs-10 col-lg-10 col-sm-8">
