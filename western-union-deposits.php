                            ...
                            <div class="box-inner">
                                <div>
                                    <div class="box-content table-responsive">
                                        <table class="col-md-12 col-sm-12 table-bordered table-striped table-condensed cf table"
                                               id="pending">
                                            <thead class="cf">
                                                <tr>
                                            ...
                                            if ($result !== false) {
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo '<td data-title="Date">' . $dt[0] . '<br>' . $dt[1] . ' (GMT ' . $dt[2] . ')</td>';
