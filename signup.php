...
if(isset($_POST['btn-signup']))
{
	...
	else
	{
		...
		if (mysqli_num_rows($verified_email) == 0) 
		{
			...
			$query_create_user = 'INSERT INTO users ( fname, mname,lname, mobile_no, password, c_password,CompanyName,SecurituyQuestion1,custom_question1,Answer1,SecurityQuestion2,custom_question2,Answer2,Country,country_res,date_of_creation) 
			VALUES ( "'.$fname.'","'.$mname.'", "'.$lname.'", "'.$mobile_no.'", "'.$password.'","'.$c_password.'","'.$Cmpname.'","'.$securityQn1.'","'.$custom_question1.'","'.$Answer1.'","'.$securityQn2.'","'.$custom_question2.'","'.$Answer2.'","'.$country.'","'.$countryres.'","'.$create_date.'")';
                          ...
                          ?>
							<form role="form" action="signup.php" onSubmit="return validate();" method="post" autocomplete="off">
								...
								<div class="form-group">
                                    ...
                                    id="register-mobile" onkeypress="javascript:return isNumberKey(event);" type="text" name="mobile_no" 
								...
								<div class="form-group">
									...
									<input onKeyUp="hide_nxt(this);" onKeyDown="hide_nxt(this);" class="form-control" id="register-password" type="password" onblur="check_pass(this);" placeholder=""
								...
								<div class="form-group">
                                    ...
                                    <input onKeyUp="hide_nxt(this);" onKeyDown="hide_nxt(this);" class="form-control" 
                                    autocomplete="off" id="register-password2" type="password" placeholder="" onblur="check_conf_pass(this);" name="c_password" 
...
function validate()
{
	...
	if(ee==true)
	{
		...
		if($("#mob_exist").val()==1)
		{
			$("#register-mobile").next('.error').children("p").html('This Mobile no is already registered');
			$("#register-mobile").next('.error').show();
			ee=false;
		}
		else
