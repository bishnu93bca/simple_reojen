        ...
        if (empty($_POST["password"]) || empty($_POST["login-email"])) {
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                if (!empty($_POST['check_list'])) {
                    ...
                    setcookie("slrememberme", $mob_id, time() + (24 * 60 * 60));
                } else {
                    ...
                    <div class="basic-login">
                        <form role="form" onSubmit="<?= ($row['value'] == 1) ? 'return validate()' : 'return validate_email()'; ?>" action="login.php" method="post">
                            <div class="form-group">
                                ...
                                <input name="login-email" onKeyUp="hide_nxt(this)" onKeyDown="hide_nxt(this)" class="form-control" 
                                       ...
                                       if (isset($_REQUEST['login-email'])) {
                                           echo $_REQUEST['login-email'];
                                       }
                                       ?>" id="login-username" type="text" placeholder="in international format; e.g. +19174971072" onkeypress="javascript:return isNumberKey(event);"
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="check_list[]" value="Keep me logged in for 1 day">
