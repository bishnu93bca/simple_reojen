        ...
        <div class="box">
			...
			<form class="form-horizontal" action="edit_user.php" method="post">
					 ...
					 <div class="form-group">
						...
						<div class="col-xs-10 col-lg-10 col-sm-8">
							<input name="mobile_no" class="form-control" onKeyUp="hide_nxt(this);" required onKeyDown="hide_nxt(this);" class="form-control" id="register-mobile" onkeypress="javascript:return isNumberKey(event);" onChange="unameValidation();" type="text" placeholder="Enter Mobile Number" value="<?php echo $value['mobile_no'] ?>">
