...
<body>
    ...
    <div class="section section-breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-md-12 support-txt">
                    <h3>To contact us via email, complete the fields below or write us at <a href="mailto:support@reojen.com">support@reojen.com</a>. If you send us an email, mention your full name, mobile number (in international format) and your country of residence in the email that is associated with your account.</h3>
                </div>
            </div>
        </div>
    </div>
