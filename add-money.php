                ...
                <div class="extras">
                    <ul>
                        <li class="shopping-cart-items">
                            ...
                            <a href="#"><b> Balance <?php echo $currency_symbol; ?> <?php echo wallet();?></b></a>
                        </li>
                        <li>
	...
	<div class="eshop-section section" style="min-height: calc(58vh - 70px);">
		<div class="container">
			...
			<div class="col-md-12">
				...
				<form name="addMoney" action="process.php" method="post">
					<div class="form-group">
						<label>Amount (in GBP)</label>
						<input type="text" name="amount" value="" class="form-control" data-validation="number" data-validation-allowing="float"data-validation-error-msg="Please ebter the correct amount" data-validation-length="max7"/>
					</div>
					<div class="form-group">
